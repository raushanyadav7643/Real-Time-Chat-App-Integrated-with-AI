...
const LoginPage = () => {
  ...
  return (
    <div className={`w-full h-full overflow-y-auto custom-scrollbar flex items-center justify-center gap-10 max-sm:justify-start sm:justify-evenly max-sm:flex-col p-8 max-sm:pt-32 max-sm:pb-20 sm:p-5 md:p-10 lg:p-[5%] relative transition-all duration-500 ${isDark ? '' : 'bg-transparent'}`}>
      ...
      {/* ------- left -------*/}
      <div className="flex-none flex items-center justify-center p-4 max-sm:mt-10 max-sm:mb-4">
        <img src={assets.logo_3d} alt="logo" className={`w-48 sm:w-56 md:w-64 lg:w-72 drop-shadow-[0_20px_50px_rgba(99,102,241,0.3)] transition-all duration-500 hover:scale-105 ${isDark ? 'mix-blend-screen' : 'mix-blend-multiply opacity-90'}`} />
      </div>
      ...
      {/* Footer Part */}
      <footer className={`flex-none w-full text-center flex flex-col items-center gap-1.5 transition-all duration-500 pb-10 sm:pb-2 mt-auto sm:mt-0 sm:absolute sm:bottom-6 z-10`}>
