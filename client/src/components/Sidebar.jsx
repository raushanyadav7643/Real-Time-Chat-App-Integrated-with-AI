...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`border-r backdrop-blur-xl h-full p-4 md:p-6 pt-[calc(22px+env(safe-area-inset-top))] overflow-y-auto custom-scrollbar flex flex-col transition-all duration-500 ${isDark ? "bg-white/5 border-white/10 text-white" : "bg-black/5 border-black/5 text-slate-900 shadow-inner"
