    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/90 backdrop-blur-md">
      {incomingCall && !onCall ? (
        ...
        <div className="w-full h-full flex flex-col relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-slate-900">
              ...
              <div className="flex items-center gap-2 text-indigo-400">
                ...
                <p className="font-medium tracking-widest uppercase text-sm">
                  {callStatus === "calling" ? "Ringing..." : `Active • ${callDuration}`}
                </p>
          ...
          {/* Time Indicator for Video Call */}
          {callType === "video" && callStatus === "connected" && (
            <div className="absolute top-6 left-1/2 -translate-x-1/2 px-4 py-1.5 bg-black/40 backdrop-blur-md rounded-full border border-white/10 z-[210]">
