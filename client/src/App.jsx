...
const App = () => {
  ...
  return (
    <div className={`h-[100dvh] w-full relative overflow-hidden transition-colors duration-500 ${isDark ? 'bg-slate-950 text-white' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <div className={`relative z-10 h-[100dvh] w-full flex flex-col overflow-hidden sticky top-0 transition-all duration-500 ${isDark ? 'bg-gradient-to-br from-gray-900 via-slate-950 to-black' : 'bg-gradient-to-br from-white via-indigo-50/30 to-slate-100'}`}>
        <Toaster />
        <CallScreen />
