...
// Frontend Part run we have use this command: 1. cd client 2. npm is not install first you are install npm 3. npm run dev.
// Backend Part run it we can use this command:- 1. cd server 2. One time check it npm install yaa not in backend part 3. npm run server.